...
def main(args):
    ...
    output_graph = scraper.scrape_url(args.url, args.depth,
                                      args.html_element)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--depth", type=int, default=2,
                        help="Depth of links")
    parser.add_argument("--html_element", required=False, default='p',
                        help="HTML element to scrape (ex: 'p')")
    parser.add_argument("--out_dir", required=False, default="../data/",
